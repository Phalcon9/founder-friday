        ...
        <div className="flex flex-col w-full max-w-[1568px] mx-auto px-4 gap-10 mt-[100px]">
            ...
            {[
                ...
                >
                    ...
                    <svg
                        className="w-[50px] h-[50px] sm:w-[60px] sm:h-[60px] md:w-[81px] md:h-[80px]"
                        viewBox="0 0 81 80"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                    >
                        <path
                            d="M40.8 20C41.4631 20 42.099 20.2634 42.5678 20.7322C43.0367 21.2011 43.3 21.837 43.3 22.5V37.5H58.3C58.9631 37.5 59.599 37.7634 60.0678 38.2322C60.5367 38.7011 60.8 39.337 60.8 40C60.8 40.663 60.5367 41.2989 60.0678 41.7678C59.599 42.2366 58.9631 42.5 58.3 42.5H43.3V57.5C43.3 58.163 43.0367 58.7989 42.5678 59.2678C42.099 59.7366 41.4631 60 40.8 60C40.137 60 39.5011 59.7366 39.0323 59.2678C38.5634 58.7989 38.3 58.163 38.3 57.5V42.5H23.3C22.637 42.5 22.0011 42.2366 21.5323 41.7678C21.0634 41.2989 20.8 40.663 20.8 40C20.8 39.337 21.0634 38.7011 21.5323 38.2322C22.0011 37.7634 22.637 37.5 23.3 37.5H38.3V22.5C38.3 21.837 38.5634 21.2011 39.0323 20.7322C39.5011 20.2634 40.137 20 40.8 20Z"
                            fill="#75687E"
                        />
                    </svg>
                </div>
